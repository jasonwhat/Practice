    ...
    return this.each(function(){
      ...
      $this.values = $.extend(
                    {
                       childTag : "p",
                       minVisible : 2,
                       excludeTag : "blockquote",
                       minTextLengthToHide : 80,
                       readMoreOpenedText : "- show less",
                       readMoreClosedText : "+ uncover story",
                       readMoreBtnClass : "uncover",
                       animationSpeed : 500
                     },params);
      ...
      $this.rdMoreId = "rd_more_" + parseInt(Math.random()*100000);
  		...
  		if( $this.total_element > ($this.values.minVisible - 1) )
  			  $(this).append( "<span style='cursor:pointer;' id = '" + $this.rdMoreId + "'class='rd_more " + $this.values.readMoreBtnClass + "'>+ uncover story</span>" );
